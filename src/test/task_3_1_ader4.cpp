// Convergence test for the ADER4 solver on the smooth advection problem.
...
void task_3_1_ader4() {
    ...
    for (int nx : nxs) {
        ...
        aderweno::ader4Run(U, x0, x1, T, CFL, true, ttopt);
    ...
    std::cout << "\nTask 3.1: Empirical convergence (ADER4 + WENO-DK M=3 + CK order 3 + TT-GRP)\n";
